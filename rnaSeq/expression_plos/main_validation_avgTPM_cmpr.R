...
if ( disease == 'UC' )
{
  ...
  genes_file = sprintf('plots/venns/lists_v3/PROTECT_%s_TPM_control.txt',type)
}
if ( disease == 'CD' )
{
  x_var ='SOURCE__Control'
  y_var = 'RISK_iCD_Ileum__Control'
  genes_file = sprintf('plots/venns/lists_v3/SOURCE_%s_TPM_control.txt',type)
}
if ( disease == 'Celiac' )
{
  x_var ='SEEM__Control'
  y_var = 'Celiac_Leonard__Control'
  genes_file = sprintf('plots/venns/lists_v3/SEEM_%s_TPM_control.txt',type)
}
