...
if (main == 'SOURCE')
  main_de_file = sprintf('../%s/res_main3TPMf_TPMf_v8/%s_v2_%s_terminal_ileum_CD_vs_Control_deseq2_res.tsv',main, main, type)
if (main == 'SEEM')
  main_de_file = sprintf('../%s/res_main3TPMf_TPMf_v8/%s_%s_Duodenum_Celiac_vs_Control_deseq2_res.tsv',main, main, type)
if (main == 'Protect')
  main_de_file = sprintf('../%s/res_main3TPMf_TPMf_v8/%s_%s_Rectal_UC_vs_Control_deseq2_res.tsv',main, main, type)
