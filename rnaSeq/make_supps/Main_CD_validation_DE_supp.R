...
DE_name = sprintf('../%s/res_main3TPMf_TPMf_v8/%s_%s_%s_%s_vs_%s_deseq2_res_filtered.tsv', cohort, gsub('SOURCE','SOURCE_v2',cohort), type, source, to_test[1],to_test[2])
...
out_file = sprintf('res/supps_v8/CD_main_validation_DE_%s_supp.txt',type)
