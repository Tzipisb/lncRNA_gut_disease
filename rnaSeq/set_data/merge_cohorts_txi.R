...
cohorts = c('Protect','RISK','Celiac_Nurit','Celiac_Leonard','IBD_Howell','Crohn_Yim','SOURCE_v2','SEEM','caco','blood')
...
for ( i in 2:length(cohorts) )
{
  ...
  tpm_file =  sprintf(tpm_file_format,cohort,cohort2,type)
  # if (cohort == 'RISK')
  # {
